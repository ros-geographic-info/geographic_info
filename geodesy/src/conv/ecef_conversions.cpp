...
geographic_msgs::msg::GeoPoint toMsg(const ECEFPoint &from)
{
  ...
  double F = 54 * wgs84::Ellipsoid::Parameters::b * wgs84::Ellipsoid::Parameters::b * from.z * from.z;
  double G = r * r + (1.0 - wgs84::Ellipsoid::Parameters::e2) * from.z * from.z - wgs84::Ellipsoid::Parameters::e2 * E2;
  double C = (wgs84::Ellipsoid::Parameters::e2 * wgs84::Ellipsoid::Parameters::e2 * F * r * r) / (G * G * G);
  double s = pow(1.0 + C + sqrt(C * C + 2 * C), 1.0 / 3.0);
  double P = F / (3.0 * pow((s + (1.0 / s) + 1.0), 2.0) * G * G);
  double Q = sqrt(1.0 + 2.0 * wgs84::Ellipsoid::Parameters::e2 * wgs84::Ellipsoid::Parameters::e2 * P);
  double r0 = (-(P * wgs84::Ellipsoid::Parameters::e2 * r) / (1.0 + Q)) +
              sqrt((1.0 / 2.0) * wgs84::Ellipsoid::Parameters::a * wgs84::Ellipsoid::Parameters::a * (1.0 + 1.0 / Q) -
  ...
  double V = sqrt(pow(r - wgs84::Ellipsoid::Parameters::e2 * r0, 2.0) + (1.0 - wgs84::Ellipsoid::Parameters::e2) * from.z * from.z);
  double Z0 = wgs84::Ellipsoid::Parameters::b * wgs84::Ellipsoid::Parameters::b * from.z / (wgs84::Ellipsoid::Parameters::a * V);
  pt.altitude = U * (1.0 - (wgs84::Ellipsoid::Parameters::b * wgs84::Ellipsoid::Parameters::b) / (wgs84::Ellipsoid::Parameters::a * V));
